...
class App extends React.Component {
    ...
    componentDidUpdate(prevState) {
        if (prevState.lineLength !== this.state.lineLength ||
    ...
    createLine() {
        ...
        // Validate bend
        const validBend = !isNaN(bendRadiusNum) &&
            !isNaN(bendLengthNum) &&
            !isNaN(bendStartNum) &&
            bendRadiusNum > 0 &&
            bendLengthNum > 0 &&
    ...
    render() {
        ...
        return (_jsxs("div", { style: { minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }, children: [_jsx("h2", { children: "3D Line Simulation" }), _jsxs("form", { style: { display: 'flex', flexWrap: 'wrap', gap: 12, marginBottom: 24, justifyContent: 'center' }, children: [_jsx("div", { children: _jsxs("label", { children: ["Line Length: ", _jsx("input", { type: "number", name: "lineLength", value: lineLength, onChange: this.handleInputChange })] }) }), _jsx("div", { children: _jsxs("label", { children: ["Bend Radius: ", _jsx("input", { type: "number", name: "bendRadius", value: bendRadius, onChange: this.handleInputChange })] }) }), _jsx("div", { children: _jsxs("label", { children: ["Bend Length: ", _jsx("input", { type: "number", name: "bendLength", value: bendLength, onChange: this.handleInputChange })] }) }), _jsx("div", { children: _jsxs("label", { children: ["Bend Start: ", _jsx("input", { type: "number", name: "bendStart", value: bendStart, onChange: this.handleInputChange })] }) })] }), _jsx("button", { onClick: this.setRandomValues, style: { marginBottom: 24 }, children: "Randomize" }), _jsx("div", { ref: this.mountRef })] }));
    }
}
export default App;
